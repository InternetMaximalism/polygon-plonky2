...
~~## 1. Free memory pointer not restored on fullProduct==0 path AND fullProduct>0 path simultaneously~~
> Fixed in round 1
...
~~## 2. Lagrange interpolation gas cost scales quadratically with degree~~
